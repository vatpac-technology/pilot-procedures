...
!!! note
    Details of each gate can be found in the [Williamtown FIHA](https://ais-af.airforce.gov.au/australian-aip).
...
The [restricted area](../../airspace/sua.md#restricted-areas) can be activated in two configurations according to the requirements of the operation. Only VFR aircraft are permitted.
...
!!! note
    Details of the coded clearance can be found in the [Williamtown FIHA](https://ais-af.airforce.gov.au/australian-aip).
...
!!! note
    Details of the coded clearances can be found in the [Williamtown FIHA](https://ais-af.airforce.gov.au/australian-aip).

## VFR Procedures
VFR aircraft transiting to/from YWLM should plan via a VFR reporting point.

Aircraft intending to transit the WLM CTR should plan via the [Coastal Route](#coastal-route) or [Inland Lane](#inland-lane).

### Coastal Route
A [lane of entry](../../airspace/lanesofentry.md) is available along the coastline, allowing aircraft to transit the zone from north to south (or vice versa). A clearance is required from **WLM TCU** prior to entering the CTR.
...
### Inland Lane
A [lane of entry](../../airspace/lanesofentry.md) is available in the Class G airspace to the north of YWLM, allowing aircraft to transit the restricted airspace from north to south (or vice versa). No clearance is required to operate along the route.
